...
namespace UkaRaffle
{
    public class UakRaffleRticketCmd : IRocketCommand
    {
        public string Name
        {
            get { return "rticket"; }
        ...
        public string Help
        {
            get { return "Buy Raffle ticket(s)"; }
        }
        ...
        {
            get { return new List<string>() { "UkaRaffle.rticket" }; }
        }

        public void Execute(IRocketPlayer caller, string[] amount)
        {
            Raffle.Instance.BuyTicket(caller, amount);
            return;
        }
